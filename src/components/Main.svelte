    ...
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10 ">
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Asep </span>Irawan <br/> Full Stack
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400">Favorite tech</span> include Javascript (SvelteKit), TailwindCSS, Node.js and Firebase/Firestore
            </p>
            <a href="www.instagram.com"
                target="_blank"
                class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3
                group rounded-full bg-white text-slate-950 cursor-pointer"
            >
        ...
        <div class="relative shadow-2xl grid place-items-center">
            ...
            <img src={"images/profile_2.png"} alt="profile image" class="object-cover z-[2] max-h-[70vh]">
        </div>
    </section>

    <section id="projects" class="py-20 lg:py-20 flex flex-col gap-24">
        <div class="flex flex-col gap-2 text-center">
            <h6 class="text-lg sm:text-xl md:text-2xl">
                Few of my creative endeavors.
            </h6>
            <h3 class=" font-semibold text-3xl sm:text-4xl md:text-5xl">
                Cruious to <span class="poppins text-violet-400">see</span> my work
            </h3>
        </div>
        <a href="instagram.com" target="_blank" class=" mx-auto px-4 py-2 rounded-md border border-solid border-white flex items-center gap-2 -mb-4 sm:-mb-0 -mt-10 hover:border-violet-700 duration-200">
            <i class=" fa-regular fa-circle-play"></i>
            <p>Watch the video</p>
        </a>
        <div class="grid grid-cols lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>Smoljames Store is a merchandising store created
            ...
            <Step step={steps[1]}>
                <p>Ultimate Todos is a Full Stack
                    <strong class="text-violet-400">Next.js, Node.js + Express.js & Firebase</strong>
                    CRUD application that allows a user to login, manage a tiny and afficacius todo list, and persist this information accross all devices.
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>Pokedex is a
                    <strong class="text-violet-400">SvelteKit & TailwindCSS</strong> web application, hosted on
                    <strong class="text-violet-400">Netflify</strong>, that consumes and caches the 
                    <strong class="text-violet-400">Pokemon API </strong> to display all pokemon information. Gotta catch em all!
    ...
    <section id="about" class=" py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
        ...
        <div class="flex flex-col overflow-x-scroll gap-10 max-w-[800px] mx-auto w-full">
            <table class="bg-white text-slate-700 rounded text-center">
                ...
                <tbody class=" border-b border-solid border-slate-200">
                    <td class=" border-right border-white border-solid pl-4 pr-8 py-4 font-semibold text-sm whitespace-nowrap">Dedication</td>
                ...
                <tbody class=" border-b border-solid border-slate-200">
                    <td class=" border-right border-white border-solid pl-4 pr-8 py-4 font-semibold text-sm whitespace-nowrap">Critical Thought</td>
                    <td><i class=" fa-solid fa-xmark text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-check text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-check text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-check text-green-500"></i></td>
                ...
                <tbody class=" border-b border-solid border-slate-200">
                    <td class=" border-right border-white border-solid pl-4 pr-8 py-4 font-semibold text-sm whitespace-nowrap">Interpersonal Skill</td>
                    <td><i class=" fa-solid fa-check text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-xmark text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-xmark text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-check text-green-500"></i></td>
                ...
                <tbody class=" border-b border-solid border-slate-200">
                    <td class=" border-right border-white border-solid pl-4 pr-8 py-4 font-semibold text-sm whitespace-nowrap">Programming Ability</td>
                    <td><i class=" fa-solid fa-check text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-check text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-xmark text-slate-500"></i></td>
                    <td><i class=" fa-solid fa-check text-green-500"></i></td>
